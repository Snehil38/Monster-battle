...
class Game:
    def __init__(self):
        ...
        self.opponent = Opponent(self.opponent_name, self.front_surfs[self.opponent_name], self.all_sprites)
    ...
    def apply_attack(self, target, attack):
        ...
        attack_multiplier = ELEMENT_DATA[attack_element][target_element]

        target.health -= base_damage * attack_multiplier
